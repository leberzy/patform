...
public abstract class BeanUtils {
	...
	public static Object instantiateClass(Class clazz) throws BeansException {
		try {
			...
			throw new BeansException("Could not instantiate class [" + clazz.getName() +
	...
	public static Object instantiateClass(Constructor constructor, Object[] arguments) throws BeansException {
		try {
			...
			throw new BeansException("Illegal arguments when trying to instantiate constructor: " + constructor, ex);
		}
		catch (InstantiationException ex) {
			throw new BeansException("Could not instantiate class [" + constructor.getDeclaringClass().getName() +
